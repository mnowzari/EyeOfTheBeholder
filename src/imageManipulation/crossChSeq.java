...
public class crossChSeq extends JFrame{

	public crossChSeq(final pixelSort ps){
		...
		setLayout(null);
		setTitle("Cross-Channel Sequential");
		setSize(300, 375);
		...
		biasPane.setSize(275, 50);
		biasPane.setLocation(0, 175);
		biasPane.setBackground(bColor);
//		biasPane.setBorder(BorderFactory.createLineBorder(cColor));
